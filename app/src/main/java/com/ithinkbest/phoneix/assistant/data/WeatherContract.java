 ...
 */
package com.ithinkbest.phoneix.assistant.data;
...
public class SurveyContract {
    ...
    // device.
    public static final String CONTENT_AUTHORITY = "com.ithinkbest.phoneix.assistant";
    ...
    public static final String PATH_SERVEY = "servey";
    ...
    public static final class SurveyEntry implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                BASE_CONTENT_URI.buildUpon().appendPath(PATH_SERVEY).build();

        public static final String CONTENT_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_SERVEY;
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_SERVEY;

        public static final String TABLE_NAME = "servey";
...
// cloud_id 	reg_id_crc32 	question_id 	ans01 	ans02 	ans03 	ans04 	ans05
